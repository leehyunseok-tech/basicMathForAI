...
| 7.6 | 로그 — 몇 제곱을 하면 되는가 |
| 7.7 | 로그함수와 로그 그래프 |
| 7.7-1 | **로그가 답해 주는 질문 — “몇 년이 걸릴까?” (투자 예시)** |
...
| 15.6-1 | **표준편차로 “이 값이 특수한가” 판단하기 (이상치 탐지)** |
...
#### [Chapter 18. 편미분과 기울기 — 손잡이가 여러 개일 때](docs/part5/ch18-gradient.md) ✅
...
#### [Chapter 19. 연쇄법칙과 경사하강법 — 학습의 전 과정](docs/part5/ch19-chain-rule-gd.md) ✅
...
| 번호 | 제목 |
|---|---|
| A | **[기호 · 그리스 문자 치트시트](docs/appendix/a-symbol-cheatsheet.md)** — 한 장으로 정리한 수식 사전 |
| B | **[삼각함수 아주 짧게](docs/appendix/b-trigonometry.md)** — 회전, 주기, 그리고 위치 인코딩 |
| C | **[수식 ↔ 파이썬/NumPy 대조표](docs/appendix/c-numpy-table.md)** — `Σ` → `sum()`, `Wx` → `W @ x` |
| D | **[2진법과 부동소수점](docs/appendix/d-floating-point.md)** — float32, bfloat16, 양자화가 하는 일 |
| E | **[다음 단계 로드맵](docs/appendix/e-next-steps.md)** — 선형대수 · 최적화 · 통계학으로 가는 길 |
...
> ✅ **전편 완료** — 6개 Part · 22개 Chapter · 부록 5편 · SVG 삽화 107장

- [x] 전체 목차 · 진행 순서 확정 (6 Part / 22 Chapter + 부록)
- [x] Part 1 (ch 1–3) 집필 — 그림 15장 포함
- [x] Part 2 (ch 4–8) 집필 — 그림 26장 포함
- [x] Part 3 (ch 9–11) 집필 — 그림 13장 포함
- [x] Part 4 (ch 12–15) 집필 — 그림 15장 포함
- [x] Part 5 (ch 16–20) 집필 — 그림 18장 포함
- [x] Part 6 (ch 21–22) 집필 — 그림 8장 포함
- [x] 부록 A–E 집필 — 그림 2장 포함
